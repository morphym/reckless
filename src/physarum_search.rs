//! Native Physarum tree search with a conservative heuristic prior.
//! Conductivity only allocates search traffic; quiescence values and minimax
//! backups determine the played move.
...
use crate::{
    ...
    types::{Color, MAX_PLY, Move, Score, normalize_to_cp},
};
...
impl Default for Runtime {
    fn default() -> Self {
        Self { budget: 4096, qnodes: 4096, seed: 2026 }
    }
}
